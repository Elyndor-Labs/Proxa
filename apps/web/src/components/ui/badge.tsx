...
export const badgeVariants = cva(
  "inline-flex items-center rounded-control border font-label text-xs font-semibold uppercase tracking-wide transition-colors",
  {
    variants: {
      variant: {
        ...
        outline: "border-(--surface-border) bg-transparent px-3 py-1 text-text-secondary",
        muted: "border-(--surface-border) bg-muted/60 px-3 py-1 text-text-secondary",
