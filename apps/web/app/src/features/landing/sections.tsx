      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          {steps.map((step, index) => (
            <div key={step.title} className="rounded-xl border border-border bg-background p-6 text-center">
...
export function FeaturedMarkets() {
  const preview = featuredMarkets[0];
    ...
    <section className="px-[var(--container-padding)] py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 flex justify-center lg:justify-start">
          <MarketCard market={preview} variant="teaser" />
        </div>
      </div>
    </section>
  );
